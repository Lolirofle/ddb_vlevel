...
public:
    ...
    // get stuff
    inline size_t GetSamples() { return m_samples; };
    inline size_t GetChannels() { return m_channels; };
    inline value_t GetStrength() { return m_strength; };
    inline value_t GetMaxMultiplier() { return m_max_multiplier; };
    inline size_t GetSilence() { return m_silence; };
